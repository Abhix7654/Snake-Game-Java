...
public class Snake extends Application {
	  ...
	  private static final int WIDTH = 800;
	    ...
	    private static final String[] FOODS_IMAGE = new String[]{"ic_orange.png", "ic_apple.png", "ic_cherry.png",
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Timeline timeline = new Timeline(new KeyFrame(Duration.millis(180), e -> run(gc)));
	  ...
	  private void drawBackground(GraphicsContext gc) {
	        for (int i = 0; i < ROWS; i++) {
	            for (int j = 0; j < COLUMNS; j++) {
	                if ((i + j) % 2 == 0) {
	                    gc.setFill(Color.web("C8CFD7"));
	                } else {
	                    gc.setFill(Color.web("969FAC"));
	                }
